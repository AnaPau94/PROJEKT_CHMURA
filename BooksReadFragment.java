...
public class BooksReadFragment extends Fragment {
    private final String booksReadUrl = "https://chmuraksiazki.herokuapp.com/api/book/all/alreadyRead";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BookModel[] allBooks;
        ResponseEntity<BookModel[]> response = restTemplate.exchange(booksReadUrl, HttpMethod.GET,request, BookModel[].class);
