...
public class BookRestController {
    ...
    public ResponseEntity<?> addOwnedBook(@RequestBody Book book, Principal principal) {
        bookService.addOwnedBookForUser(userService.getAuthUserId(principal), book);
        return new ResponseEntity<>("created", HttpStatus.OK);
    }

    @RequestMapping(value = "/add/buy", method = RequestMethod.POST)
    public ResponseEntity<?> createBookToBuy(@RequestBody Book book, Principal principal) {
