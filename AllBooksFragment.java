...
public class AllBooksFragment extends Fragment {
    private final String booksToReadUrl = "https://chmuraksiazki.herokuapp.com/api/book/all/owned";
    ...
    public static AllBooksFragment newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for (int i = 0; i<objects.length; i++){
            allBooks.add((BookModel)objects[i]);
        }
        ...
        for (int j = 0; j < 2; j++) {
            for (int i = 0; i < allBooks.size(); i++) {
                listViewAdapter.add((allBooks.get(i).getBookTitle()));
            }
        }
